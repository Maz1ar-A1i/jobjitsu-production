    ...
    <div className="min-h-screen bg-background text-on-surface font-body selection:bg-primary/30 relative overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 relative z-10 space-y-12">
        <section className="text-center space-y-6 animate-fade-in-up">
          ...
          <p className="text-sm font-bold uppercase tracking-widest text-on-surface-variant/60">Effective Date: October 2026</p>
        </section>
        ...
        <section className="glass-panel p-8 md:p-12 rounded-[2rem] border border-outline-variant/10 shadow-2xl relative overflow-hidden space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              By accessing or using the JobJitsu platform, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access our service.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              You are responsible for safeguarding the password that you use to access JobJitsu and for any activities or actions under your password. You agree not to disclose your password to any third party.
            </p>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl font-headline font-bold text-white">3. Acceptable Use</h2>
            <p className="text-on-surface-variant leading-relaxed">
              You agree not to use the service to generate harmful, illegal, or abusive content during the mock interviews. JobJitsu reserves the right to terminate accounts that violate this policy.
            </p>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl font-headline font-bold text-white">4. Modifications</h2>
            <p className="text-on-surface-variant leading-relaxed">
