    ...
    <div className="min-h-screen bg-background text-on-surface font-body selection:bg-primary/30 relative overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 relative z-10 space-y-12">
        <section className="text-center space-y-6 animate-fade-in-up">
          ...
          <p className="text-sm font-bold uppercase tracking-widest text-on-surface-variant/60">How we keep your data safe</p>
        </section>
        ...
        <section className="glass-panel p-8 md:p-12 rounded-[2rem] border border-outline-variant/10 shadow-2xl relative overflow-hidden space-y-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-headline font-bold text-white">1. Encryption at Rest & In Transit</h2>
            <p className="text-on-surface-variant leading-relaxed">
              All communications between your browser and our servers are encrypted via HTTPS. Additionally, sensitive user data, including stored session transcripts and audio, is encrypted at rest using AES-256 standards.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant leading-relaxed">
              We process your audio data strictly for generating interview feedback. Our AI models do not retain your audio to train foundational models. Audio files are temporarily cached for analysis and securely wiped following your session.
            </p>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl font-headline font-bold text-white">3. Access Control</h2>
            <p className="text-on-surface-variant leading-relaxed">
              We utilize JSON Web Tokens (JWT) for secure authorization and session management. Access to internal production environments is restricted via VPNs, multi-factor authentication, and strict role-based access control (RBAC).
            </p>
          </div>
        </section>
      </main>
